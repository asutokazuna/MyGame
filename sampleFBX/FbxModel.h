...
public:
	...
	void CalcBoundingBox(DirectX::XMFLOAT3& vMin, DirectX::XMFLOAT3& vMax);
	void CalcBoundingSphere(DirectX::XMFLOAT3& vCenter, float& fRadius);
