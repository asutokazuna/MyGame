...
// 属性
private:
	static CWindow*	m_pMainWnd;		// メイン ウィンドウ
...
public:
	...
	static HWND GetMainHwnd() {return (m_pMainWnd) ? m_pMainWnd->GetHwnd() : NULL;}

	// インスタンスハンドル
	static HINSTANCE GetHinstance() { return (m_pMainWnd) ? m_pMainWnd->m_hInstance : NULL; }
